...
#admrates
skim(admrates) %>% tibble::as_tibble()
print(length(admrates))
...
#admrates
skim(undergrads) %>% tibble::as_tibble()
```
...
#admrates
skim(admrates2) %>% tibble::as_tibble()
